...
class ListOfDiningAreasWidget extends StatefulWidget {
  const ListOfDiningAreasWidget({
    super.key,
  ...
  final void Function(DiningAreaModel item)? onEdit;
  final void Function(DiningAreaModel item)? onDelete;

  @override
  State<ListOfDiningAreasWidget> createState() =>
      _ListOfDiningAreasWidgetState();
}

class _ListOfDiningAreasWidgetState extends State<ListOfDiningAreasWidget> {
  ...
  Widget build(BuildContext context) {
    if (widget.diningAreas.isEmpty) {
      return Center(
        child: Text(
          'table.no_dining_areas'.tr(),
        ...
        return PosCrudSectionCard(
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.dining_outlined, color: AppColors.primary),
                      ...
                      child: ConstrainedBox(
                        ...
                        child: DataTable(
                          ...
                          columns: [
                            ...
                            DataColumn(label: Text('table.dining_area'.tr())),
                          ...
                          rows: [
                            for (var i = 0; i < widget.diningAreas.length; i++)
                              DataRow(
                                ...
                                cells: [
                                  DataCell(
                                    CustomText(
                                      text:
                                          '${widget.diningAreas[i].id ?? '-'}',
                                      needSelectable: true,
                                    ),
                                  ),
                                  DataCell(
                                    CustomText(
                                      text: widget.diningAreas[i].name ?? '-',
                                      needSelectable: true,
                                    ),
                                  ),
                                  DataCell(
                                    CustomText(
                                      text:
                                          widget.diningAreas[i].branchName ??
                                          '-',
                                      needSelectable: true,
                                    ),
                                  ),
                                  DataCell(
                                    CustomText(
                                      text: _formatLastUpdate(
                                        widget.diningAreas[i].updatedAt,
                                      ),
                                      needSelectable: true,
                                    ),
                                  ),
