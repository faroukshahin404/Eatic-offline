...
class DiscountAmountDialog extends StatefulWidget {
  const DiscountAmountDialog({super.key});

  @override
  State<DiscountAmountDialog> createState() => _DiscountAmountDialogState();
}

class _DiscountAmountDialogState extends State<DiscountAmountDialog> {
  String _amountText = '';
  ...
  void _onEnter() {
    final value = _amountText.trim().isEmpty ? null : double.tryParse(_amountText.trim());
    context.read<CartCubit>().setDiscountByAmount(value);
