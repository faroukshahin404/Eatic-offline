...
class ListOfPriceListsWidget extends StatefulWidget {
  ...
  @override
  State<ListOfPriceListsWidget> createState() =>
      _ListOfPriceListsWidgetState();
}
                      ...
                      for (var i = 0; i < widget.priceLists.length; i++)
                        DataRow(
                          ...
                          cells: [
                            ...
                            DataCell(
                              CustomText(
                                text: widget.priceLists[i].name ?? '-',
                                needSelectable: true,
                              ),
                            ),
                            DataCell(
                              CustomText(
                                text: widget.priceLists[i].currencyName ?? '-',
                                needSelectable: true,
                              ),
                            ),
                            DataCell(
                                ...
                                children: [
                                  if (widget.onEdit != null)
                                    _ActionIcon(
                                      ...
                                      onTap: () =>
                                          widget.onEdit!(widget.priceLists[i]),
                                    ),
