...
class ListOfPriceListsWidget extends StatefulWidget {
  const ListOfPriceListsWidget({
    super.key,
  ...
  final void Function(PriceListModel item)? onEdit;
  final void Function(PriceListModel item)? onDelete;

  @override
  State<ListOfPriceListsWidget> createState() => _ListOfPriceListsWidgetState();
}

class _ListOfPriceListsWidgetState extends State<ListOfPriceListsWidget> {
        ...
        return PosCrudSectionCard(
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.price_change_outlined, color: AppColors.primary),
                      ...
                      child: ConstrainedBox(
                        ...
                        child: DataTable(
                          ...
                          columns: [
                            ...
                            DataColumn(label: Text('table.price_type'.tr())),
                              ...
                              DataRow(
                                ...
                                cells: [
                                  ...
                                  DataCell(
                                    CustomText(
                                      text:
                                          widget.priceLists[i].currencyName ??
                                          '-',
                                      needSelectable: true,
                                    ),
                                  ),
